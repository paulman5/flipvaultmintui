...
export const MESSAGE_MODULE_ADDRESS =
  process.env.NEXT_PUBLIC_MESSAGE_MODULE_ADDRESS
...
export const GOOGLE_CLIENT_ID =
  "306513074110-tci597uh8358u7o9il0au1ucok2ib787.apps.googleusercontent.com"
